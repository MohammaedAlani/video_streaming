...
<script src="{{ asset('assets/js/jquery-file-upload.js') }}" defer></script>
<script src="{{ asset('assets/js/dropzone.js') }}" defer></script>
<script src="{{ asset('assets/js/resumable.js') }}" defer></script>
